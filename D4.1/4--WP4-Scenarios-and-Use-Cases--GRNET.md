...
* **Scenario 1: Streamlined Travel Experience.** Covers the traveller's journey from booking to boarding across air, rail, ferry, and urban transport, with a focus on cross-border travel, efficiency, and reduction of paper-based procedures. This scenario builds on interactions with WP3 (Digital Travel Credentials) for travel documents and with WP6 (PBEE Framework) for payment steps.
* **Scenario 2: Hotel Check-In.** Covers the hotel guest experience from online booking through arrival at the property, with a focus on streamlining the check-in procedure, addressing national guest-registration requirements, and reducing waiting times and friction at reception.
* **Scenario 3: Student Access.** Covers student mobility across European campuses, including the issuance of next-generation student credentials to the EUDIW, cross-campus travel at student fares, and access to services and discounts at host institutions.
...
| 3 | Seamless Digital Traveller Experience (SEDIT-X) | UAegean |
| 4 | Streamlined Travel Experience | FastID |
| 5 | Stadium Access | FastID |
| 6 | European Student Experience / Student Access via EUDI Wallet | iDAKTO & PagoPA |
| 7 | Accessing Discounted Train Fares via EUDIW | PagoPA |
| 8 | Overnight Hospitality & Cross-Border Train Journey | PagoPA |
| 9 | Biometric Profile / Carrier Held Biometrics for Seamless Airport Travel | IN Groupe |
